...
//  GuildBrowser
//
//  Created by Matthew Lu on 9/08/13.
...
-(void)testCreateCharacterFromDetailJsonProps {
    ...
    STAssertEqualObjects(_testGuy.realm, @"Borean Tundra", @"realm is wrong"); STAssertEqualObjects(_testGuy.achievementPoints, @3130, @"achievement points is wrong");STAssertEqualObjects(_testGuy.level,@85, @"level is wrong");
